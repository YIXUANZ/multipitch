...
class DCCRN(nn.Module):
    def __init__(self):
        ...
        self.conv1 = DenseConv2d(4, 6, (1,4), padding=(0,1), stride=(1,2), grate=8)
        self.conv2 = DenseConv2d(6, 8, (1,4), padding=(0,1), stride=(1,2), grate=8)
        ...
        self.fc1 = nn.Linear(4*256, self.pstates)
        self.fc2= nn.Linear(4*256, self.pstates)
        
        self.bceloss = nn.BCEWithLogitsLoss(reduction='none')
        self.bceloss_mean = nn.BCEWithLogitsLoss(reduction='mean')
